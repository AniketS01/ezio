  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        ...
        const res = await fetch('https://ezio.onrender.com/api/dalle', {
          method: 'POST',
          headers: {
    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-gray-500 text-[17px] max-w-[500px]'>
          create visually stunning images generated by ezio and share.
        </p>
      </div>
        ...
        <div className='flex flex-col gap-5'>
          ...
          <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 flex justify-center items-center'>
            {form.photo ? (
              ...
              <img
                src={
                  'https://www.cencoos.org/wp-content/plugins/post-grid/assets/frontend/images/placeholder.png'
                }
                alt='preview'
